...
class SamosvalRequest extends FormRequest
{
    ...
    {
        return [
            'status.required' => 'Необходимо выбрать статус: "Активен/Неактивен/В ремонте".',
            'status.in' => 'Допустимые статусы: "Активен", "Неактивен", "В ремонте".',
            ...
            'type.min' => 'Тип должен содержать не менее 2 символов.',
            'type.max' => 'Тип должен содержать не более 50 символов.',

            'address.required' => 'Заполните поле "Адрес / объект".',
